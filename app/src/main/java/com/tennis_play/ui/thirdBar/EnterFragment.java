package com.tennis_play.ui.thirdBar;
...
import com.tennis_play.databinding.FragmentEnterBinding;

public class EnterFragment extends Fragment
{
    private FragmentEnterBinding mainBinding;

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        mainBinding = FragmentEnterBinding.inflate(inflater);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        String url = "https://tennis-play.com/5/";
